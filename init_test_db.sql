...
DROP DATABASE IF EXISTS oois_assignment_test;
CREATE DATABASE oois_assignment_test;

-- Uses the database
USE oois_assignment_test;
...
CREATE TABLE IF NOT EXISTS appointment (
    ...
    `healthcare_professional_id` VARCHAR(255) NOT NULL,
    `patient_id` VARCHAR(255) NOT NULL,
